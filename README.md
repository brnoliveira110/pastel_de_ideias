...
<li>Abra uma nova aba no terminal do seu editor de código, verifique se o terminal está na pasta do projeto se não entre com *cd pastel_de_ideias-master* e coloque a API para rodar com o comando: npm run backend.</li>
